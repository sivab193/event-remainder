...
describe("BirthdayCard", () => {
  ...
  it("renders birthday information correctly", () => {
    ...
    expect(screen.getByText("May 15")).toBeDefined()
  ...
  it("sends test notification successfully", async () => {
    ...
    const testNotifyButton = screen.getByText(/Test Notification/i)
    fireEvent.click(testNotifyButton)
    ...
    expect(global.fetch).toHaveBeenCalledWith("/api/test-notification", expect.any(Object))
  })
})
